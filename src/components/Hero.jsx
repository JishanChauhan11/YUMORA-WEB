    ...
    <section className="hero">
      <div className="hero-content">
        ...
        <motion.h1
          ...
          transition={{ delay: 0.1, duration: 0.5 }} /* Faster (was 0.8) */
        >
          FRESHNESS <br /> 
        ...
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3, duration: 0.5 }} /* Faster */
        >
      ...
      <div className="hero-visual">
        ...
        <motion.div 
          className="circle-bg"
          animate={{ rotate: 360 }}
          transition={{ duration: 20, repeat: Infinity, ease: "linear" }} /* Slightly faster rotation */
        ></motion.div>
        ...
        <motion.img 
          ...
          transition={{ duration: 0.6, delay: 0.2 }} /* Faster entry */
